  ...
  return (
    <Box>
      <Box
        ...
        backgroundImage={{
          md: "url('https://cimages.milaap.org/milaap/image/upload/v1655996033/production/entity_details/milaap_page/524/Desktop_img_2__5__1655996032.jpg')",
      ...
      >
        <Box
          ...
          mt={2}
        >
          <Text justify={"space-between"} fontSize="19px" fontWeight="500">
            Fundraising just got a fun new makeover with Milaap360!{" "}
          </Text>{" "}
          <Spacer /> <AiFillRightCircle size={"25px"} color="#9c3353" />
        </Box>
      ...
      <Box w={"full"} mt={10}>
        ...
        <Box mt={"100px"}>
          ...
          >
            <Box
              onClick={() => handleingBtn1()}
              shadow="#9c3353 0px 5px 15px"
              padding={{
                base: "6px 10px",
                sm: "15px 20px",
                md: "20px 30px",
            ...
            >
              <Image
                ...
                src={`${
                  imgbutn3
                    ? "https://assets.milaap.org/assets/home/education-transparent-icon-396c16d8ccd62e9bcc40fcad99256db78b6af27a3098de70128942a68af07f19.png"
                    : "https://assets.milaap.org/assets/home/education-icon-710f135e0b777734a9ca958da28464f386379cb78ed4880e978ac9790eb45a8d.png"
                }`}
              />
          ...
          {/* <Box w={"80%"} m="auto" display="flex" alignItems={"center"} justifyContent="center" >
              ...
              <SimpleGrid columns={{md:2  ,lg: 2,xl: 3,"2xl":3  }} alignItems="center" justifyContent={"center"} spacing='40px'>
                {storedata.length > 0 && storedata.map((item)=> {
                  return  <HomeDataCard key={item.id} Data={item}/>
                })}
              </SimpleGrid>
      </Box> */}
          ...
          >
            <SimpleGrid
              columns={{ md: 2, lg: 2, xl: 3, "2xl": 3 }}
              alignItems="center"
              justifyContent={"center"}
              spacing="40px"
            >
              {storedata?.map((e) => {
                return <HomeDataCard data={e} />;
              })}
            </SimpleGrid>
          </Box>
        ...
        >
          ...
          >
            <Image
              borderRadius={15}
              shadow="rgb(156,51,83) 0px 5px 15px"
              src="https://i.imgur.com/5IIOe3N.png"
              h="object-fit"
              w="object-fit"
            />
          </Box>
